...
import { GiCat, GiCow, GiWeight, GiBarn, GiInfo, GiCalendar, GiFemale, GiMale } from 'react-icons/gi';
import MainLayout from '../../components/MainLayout';
import { getHealthStatusColor, getHealthStatusText } from '../buscaranimal/healthStatusUtils';
import { getTipoEventoColor, tipoEventoLabels } from '../../components/novedades/NovedadStatusUtils';
