...
export default function AgregarParteAfectadaForm() {
  ...
  return (
    <div className="max-w-xl mx-auto bg-white rounded-lg shadow-lg border border-green-100 mt-10 p-8">
      <h2 className="text-2xl font-bold text-green-900 mb-6">Agregar Parte Afectada</h2>
      <form className="space-y-5">
        <div>
          <label className="block font-medium mb-1 text-green-800 text-lg font-bold">Nombre de la parte afectada</label>
          <input
            type="text"
            name="nombre"
            value={form.nombre}
        ...
        <div>
          <label className="block font-medium mb-1 text-green-800 text-lg font-bold">Tipo de parte</label>
          <input
            type="text"
            name="tipo"
            value={form.tipo}
